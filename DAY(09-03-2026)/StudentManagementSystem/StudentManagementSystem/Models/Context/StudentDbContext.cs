    ...
    public class StudentDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Student>().HasData(
                new Student { StudentId = 1, Name = "Alice Johnson", Age = 20, Email = "alice@example.com", DepartmentId = 1, Gender = "Female", Password = "PassValue" },
                new Student { StudentId = 2, Name = "Bob Smith", Age = 22, Email = "bob@example.com", DepartmentId = 2, Gender = "Male", Password = "PassValue" }
            );
        }
